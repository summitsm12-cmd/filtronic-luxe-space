    ...
    >
      <div className="container-px mx-auto max-w-7xl flex items-center justify-between h-20">
        ...
        <div className="hidden lg:block">
          <Link
            to="/contact"
            className="inline-flex items-center px-6 h-11 rounded-md bg-brand-indigo text-secondary-foreground text-sm tracking-wide hover:bg-brand-green transition-colors duration-500 shadow-soft"
          >
            Book Consultation
          </Link>
        </div>
